...
import contactApi from '../apicontact/contact'; 
            ...
            <div className={`${lun.className}`}>
              <div className="flex flex-row">
                <div className="px-1 mb-2">
                  <label for="name" className="block text-xs text-black">Full Name</label>
                  <input type="text" id="fullname" className="bg-gray-50 border border-black text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full px-2 py-0.5" placeholder="First Name" required/>
                </div>
                <div className="px-1 mb-2">
                  <label for="name" className="block text-xs text-black">Last Name</label>
                  <input type="text" id="lastname" className="bg-gray-50 border border-black text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full px-2 py-0.5" placeholder="Surname" required/>
                </div>
              </div>
              <div className="md:flex md:flex-row">
                ...
                <div className="px-1  mb-2">
                    ...
                    <input type="text" id="phone_number" className="bg-gray-50 border border-black text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full px-2 py-0.5" placeholder="Phone Number" required/>
                </div>
              </div>
              <div className="px-1 mb-2">
              ...
              <div className="px-1 mb-4">
                  ...
                  <textarea type="text" name="" id="message" className="bg-gray-50 border border-black text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full h-20 px-2 py-0.5" placeholder="Keterangan Tambahan" required/>
              </div>
